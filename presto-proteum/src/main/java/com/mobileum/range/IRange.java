...
public interface IRange<T extends Comparable<T>> {
	/**
	 * Returns <code>true</code> if the lowest value in this range occurs after
	 * the greatest value in <code>range</code>.
	 * 
	 * @param range
	 *            The range to test
	 * @return <code>true</code> if the lowest value in this range occurs after
	 *         the greatest value in <code>range</code>
	 */
	...
	/**
	 * Returns <code>true</code> if the greatest value in this range occurs
	 * before the lowest value in <code>range</code>.
	 * 
	 * @param range
	 *            The range to test
	 * @return <code>true</code> if the greatest value in this range occurs
	 *         before the lowest value in <code>range</code>
	 */
	...
	/**
	 * Retuns true if both the ranges are adjacent.means there are no point
	 * exists between these two ranges. If lower range ends with T1 and upper
	 * range starts with T2.Then will return true if there is no T between T1
	 * and T2.
	 * 
	 * @param range
	 * @return
	...
	/**
	 * Returns <code>true</code> if the greatest value in this range not occurs
	 * after the greatest value in <code>range</code>.
	 * 
	 * @param range
	 *            The range to test
	 * @return <code>true</code> if the greatest value in this range not occurs
	 *         after the greatest value in <code>range</code>.
	 */
	...
	/**
	 * Returns <code>true</code> if the greatest value in this range not occurs
	 * after the greatest value in <code>value</code>.
	 * 
	 * @param range
	 *            The range to test
	 * @return <code>true</code> if the greatest value in this range not occurs
	 *         after <code>value</code>.
	 */
	boolean notEndsAfter(T value);

	/**
	 * Returns <code>true</code> if the lowest value in this range not occurs
	 * before the lowest value in <code>range</code>.
	 * 
	 * @param range
	 *            The range to test
	 * @return <code>true</code> if the lowest value in this range not occurs
	 *         after the lowest value in <code>range</code>.
	 */
	boolean notStartsBefore(Range<T> range);

	/**
	 * Returns <code>true</code> if the lowest value in this range not occurs
	 * before the lowest value in <code>value</code>.
	 * 
	 * @param range
	 *            The range to test
	 * @return <code>true</code> if the lowest value in this range not occurs
	 ...
	 * @param other
	 *            The range to test
	 * @return portion of this not contained by <code>other</code> as
	 *         {@link Range}.
	 */
	Range<T> minus(Range<T> other);

	/**
	 * Return Domain of the range.It may be discrete or contiguous.
	 * 
	 * @return Domain of the range.
	 */
	Domain<T> getRangeDomain();

	/**
	 * Return Serializer to serialize and deserialize range.It is used to get
	 * Range from String or from bytes and vice versa.
	 * 
	...
	public static final byte RANGE_LB_NULL = 0x20; // lower bound is null (NOT
													// USED)
	public static final byte RANGE_UB_NULL = 0x40;// upper bound is null (NOT
													// USED)
}
