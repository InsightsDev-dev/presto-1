...
public class MetadataPartition implements ConnectorPartition {
	private final String schemaName;
	private final String tableName;

	public MetadataPartition(String schemaName, String tableName) {
	...
	public String toString() {
		return Objects.toStringHelper(this).add("schemaName", schemaName)
