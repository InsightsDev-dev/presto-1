...
public final class MetadataTableHandle implements ConnectorTableHandle {
	private final String connectorId;
	private final String schemaName;
	private final String tableName;

	@JsonCreator
	public MetadataTableHandle(@JsonProperty("connectorId") String connectorId,
	...
	public boolean equals(Object obj) {
		...
		MetadataTableHandle other = (MetadataTableHandle) obj;
