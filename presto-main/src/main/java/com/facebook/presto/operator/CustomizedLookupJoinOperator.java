        ...
        implements Operator, Closeable
{
    ...
    public CustomizedLookupJoinOperator(
    ...
    {//if join position is greater than 0 than set flag to true;when we process set flag to false;check condition here
        //
        ...
        while (joinPosition >= 0) {
            ...
            boolean isFilterEveluvateToTrue =
                    customizedInMemoryJoinHash.applyFilter(operatorContext.getSession().toConnectorSession(),filterJoinCondition, ((SimpleJoinProbe) probe).getBlocks(),
                            ((SimpleJoinProbe) probe).getPosition(), joinPosition);
